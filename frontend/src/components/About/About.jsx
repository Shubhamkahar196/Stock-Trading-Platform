    ...
    <>
      ...
      <main className="max-w-7xl mx-auto px-4 py-12  ">
        ...
        <section className="flex flex-col lg:flex-row gap-10 mt-10">
          ...
          <div className="w-full lg:w-1/2 space-y-4">
            <p>
              ...
              <br />
              <br />
              <a href="https://rainmatter.com" className="text-blue-600">
                Rainmatter
              </a>
              ...
              <a href="https://zerodha.com/media" className="text-blue-600">
                saying about us
              </a>
        ...
        <section className="mt-20">
          <h3 className="text-3xl font-semibold text-center mb-10">People</h3>
          ...
          <div className="flex flex-col lg:flex-row items-center gap-10 max-w-5xl mx-auto">
            ...
            <div className="flex flex-col items-center text-center lg:w-1/3">
              ...
              />
              <h3 className="mt-4 font-semibold text-lg">Nithin Kamath</h3>
            ...
            <div className="lg:w-2/3 text-gray-700 space-y-4">
              ...
              <p>
                ...
                <a href="https://nithinkamath.me" className="text-blue-600">
                  Homepage
                </a>{" "}
                /{" "}
                <a
                ...
                /{" "}
                <a href="https://x.com/Nithin0dha" className="text-blue-600">
                  Twitter
                </a>
              </p>
            </div>
